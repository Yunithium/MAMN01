...
public class PlaybackActivity extends Activity implements CustomActivity {
	...
	public void previousTrack() {
		...
		// MEDIAPLAYER
		mediaPlayer.release();
		rollingStone.currentSong = (rollingStone.currentSong + (rollingStone.trax.length - 1))
				% rollingStone.trax.length;
		mediaPlayer = MediaPlayer.create(this,
				rollingStone.trax[rollingStone.currentSong]);
		mediaPlayer.start();
		// END MEDIAPLAYER
	...
	public void nextTrack() {
		...
		// MEDIAPLAYER
		mediaPlayer.release();
		rollingStone.currentSong = (rollingStone.currentSong + 1)
				% rollingStone.trax.length;
		mediaPlayer = MediaPlayer.create(this,
				rollingStone.trax[rollingStone.currentSong]);
		mediaPlayer.start();
